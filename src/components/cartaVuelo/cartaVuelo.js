...
export default function CartaVuelo() {
  return (
      ...
      <View>
        <DataTable>
          <DataTable.Header>
            ...
            <DataTable.Title textStyle={{ fontSize: 15 }} style={styles.Table}>Nerthlands</DataTable.Title>
          </DataTable.Header>
          <Divider />
          <DataTable.Header>
            <DataTable.Cell textStyle={{ fontWeight: 'bold', fontSize: 15 }}>Septiembre 3 2020</DataTable.Cell>
            <DataTable.Cell textStyle={{ fontWeight: 'bold', fontSize: 15 }} style={styles.Table}>2 passengers</DataTable.Cell>
          </DataTable.Header>
